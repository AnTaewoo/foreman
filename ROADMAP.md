...
| P9.9 | 프로젝트별 installation으로 실행 경로(runner·runtime·repo_cache·pr_opener) | P9.8 | done | (this) |
| P9.10 | 연결 API: 설치가 곧 권한, `installation_id` 기록, 빈 repo 초기 커밋, 점검 경고 강등 | P9.9 | running | |
